...
import robomimic.robomimic.envs.env_base as EB
from robomimic.robomimic.utils.log_utils import log_warning
...
def get_env_class(env_meta=None, env_type=None, env=None):
    ...
    if env_type == EB.EnvType.ROBOSUITE_TYPE:
        from robomimic.robomimic.envs.env_robosuite import EnvRobosuite
        return EnvRobosuite
    elif env_type == EB.EnvType.GYM_TYPE:
        from robomimic.robomimic.envs.env_gym import EnvGym
        return EnvGym
    elif env_type == EB.EnvType.IG_MOMART_TYPE:
        from robomimic.robomimic.envs.env_ig_momart import EnvGibsonMOMART
